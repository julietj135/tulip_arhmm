...
from .io import save_hdf5, extract_results, load_checkpoint
from .jaxmoseq.models import allo_keypoint_slds, keypoint_slds
...
from .jaxmoseq.models.arhmm import stateseq_marginals, marginal_log_likelihood
...
def init_model(
    *args, location_aware=False, allo_hypparams=None, trans_hypparams=None, fix_heading=False, neglect_location=False, **kwargs
):
    ...
    if location_aware:
        ...
        return keypoint_slds.init_model(
            *args, trans_hypparams=trans_hypparams, fix_heading=fix_heading, neglect_location=neglect_location, **kwargs
        )
...
def apply_model(
    ...
    **kwargs,
    ...
    #     model, metadata, project_dir, model_name, data, None, save_results, results_path
    # )
    
    results = extract_results(model, metadata, project_dir, model_name, data, None, None, None)
